...
type TextAreaProps = React.TextareaHTMLAttributes<HTMLTextAreaElement> & {
  ...
  required?: boolean; // Optional: Add a required prop
};
...
const TextArea: React.FC<TextAreaProps> = ({
  ...
  id,
  name,
  required, // Optional: Destructure the required prop
  ...props
}) => {
  ...
  return (
    <div className="w-full">
      ...
      <textarea
        ...
        {...props}
        {...register(name, { required: required ? 'This field is required' : false })} // Apply register here with conditional required validation
      />
      {error && (
